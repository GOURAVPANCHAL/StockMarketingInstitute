...
const AboutHemant = () => {
  return (
    <div>
        ...
        <div className="main">
            <h2 className="contactHeading mt-3 mb-5"><u>About Hemant Sharma</u></h2>
            <p className="para">
              ...
              affiliation with ACCA, he shifted his career to the dynamic world
              of the stock market. By 2018, driven by a desire for autonomy, he
              became a full-time trader, choosing entrepreneurship over
              traditional employment.
            </p>
            <p className="para">
              Hemant's success is built on a blend of self-education and
              hands-on experience at a proprietary trading desk for about three
              years. During this time, he managed funds ranging from Rs 2.5 to 3
              CR, mastering various option trading strategies, including Hedge
              and Arbitrage Trading Strategies. His professional expertise is
              further validated by the prestigious NISM License, highlighting
              his commitment to excellence and regulatory compliance in the
              stock market.
            </p>
            <p className="para">
              One of Hemant's standout qualities is his ability to apply
              theoretical knowledge to real-world scenarios. With a strong
              command of Technical Analysis, especially chart analysis, he is a
            ...
            <p className="para">
              ...
              like effective risk management and sound money management
              practices. Hemant stresses the need for psychological resilience,
              particularly in dealing with the ups and downs of trading. For
              him, acknowledging losses is not a sign of weakness but a vital
              step towards preserving capital and ensuring long-term
              sustainability.
            </p>
            <p className="para">
