                        ...
                        <ol>
                          <li className="para">
                            ...
                            <ol>
                              ...
                              <li>
                                Difference between technical & fundamental
                                analysis
                              </li>
                              <li>
                          ...
                          <li>
                            ...
                            <p className="heading mt-5 mb-2">
                              CURRENCY ANALYSIS CORRELATION OF EVENTS ECONOMIC
                              DATA ANALYSIS
                            </p>
                            <ol>
                              <li>Inventory</li>
                          ...
                          <li>Company Analysis (Valuation)
                            ...
                            <p className="para" style={{color:'gray'}}>This Strategy is based on Market & Data Analysis</p>
                            ...
                            <ol>
                              ...
                              <li>Those who want to pursue the career in financial service</li>
                            </ol>
                            <p>
                              <b>Career Opportunity</b>
                            </p>
                            <p className="para">You can become Equity Analyst & Stock Analyst and you become fit for various other posts in various other verticals depending on your overall Qualifications</p>
                            <p className="para">Who can take this course?</p>
                            <p className="para">
                            It is designed to help Students, Day traders, Investors, Sub-brokers, stock Brokers, Chartered accountants, Housewives Relationship  Managers, Traders, Consultants, Entrepreneurs, etc
                            Features & Benefits
                            </p>
                            <ol>
