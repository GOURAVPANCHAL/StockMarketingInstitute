    ...
    <div className="container">
      <div className="container mt-5 mb-5">
        ...
        <p className="para" style={{ color: "gray" }}>
          ...
          calls /tips through SMS, website, radio, T.V. or any other public
          media or wish to provide call to their clients. As per SEBI regulation
          2014, NISM series 15 research analyst certification is must and aims
          to entrance qualify of service provides by the research analyst in the
          financial service industry.
        </p>
        <p className="para" style={{ color: "gray" }}>
          Diploma in research analyst is a job oriented program. This program is
          a comprehensive program aimed to correlate and combine knowledge
          of Technical analysis/ Fundamental analysis and research analysis. It
          is now mandatory for research departments in broking house, research
        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingFive">
              ...
              >
                Module 3. - Research Analyst Certification (NISM Certification)
              </p>
            </h2>
            <div
            ...
            >
              <div class="accordion-body">
                ...
                <ol>
                  ...
                  <li>
                    Along with graduation a 100% skill oriented and job oriented
                    program
                  </li>
